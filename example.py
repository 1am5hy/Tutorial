...
doc321 = ET.SubElement(doc32, "geom", type="capsule", fromto="0 0 1  0 0 0.3, "geom", type="capsule", fromto="0 0 0.6  0.3 0 0.6", size="0.04")
...
doc32341 = ET.SubElement(doc3234, "geom", type="sphere", pos="0.4 0 0.6", size="0.1 0.08 0.02")
doc32342 = ET.SubElement(doc3234, "site", name="end1", pos="0.5 0 0.6", type="sphere", size="0.01")
